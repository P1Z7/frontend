...
const BottomButton = ({ onClick, children, isDisabled, isSkip = false, isSubmit = false }: Props) => {
  return (
    <div className="fixed bottom-0 left-0 z-nav mt-auto flex w-full flex-col items-center gap-12 border-t border-gray-50 bg-white-black px-20 pb-24 pt-12 pc:sticky">
