...
import LinedHeartIcon from "@/public/icon/heart.svg";
...
const HeartButton = ({ isSmall = false, isSelected = false, isLined = false, onClick, ...props }: Props) => {
