...
const EventCard = ({ data, isSelected, onCardClick }: Props) => {
  ...
  return (
    <>
      <div onClick={onCardClick} className={`relative flex w-full cursor-pointer items-center gap-12 border-b border-gray-50 bg-white-black py-12`}>
